...
const colorSelectionContainer = document.querySelector(
...
themeButtons.forEach((button) => {
    button.addEventListener("click", function () {
        ...
        colorSelectionContainer.classList.remove(
            "theme-red",
            "theme-blue",
            "theme-yellow"
        );
        ...
        document
            .querySelectorAll(".menu-container a.menu-item")
            .forEach((item) => {
...
//  Byter vyer
document
    .getElementById("all-pokemons-link")
...
document
    .getElementById("team-pokemons-link")
    .addEventListener("click", function () {
